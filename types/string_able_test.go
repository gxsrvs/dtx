...
func TestToString(t *testing.T) {
	...
	cases := []struct {
		...
		{"NullDate", NullDateFromTime(d), "1969-07-20"},
		{"NullOffsetTime", NullOffsetTimeFromTime(time.Date(0, 1, 1, 20, 17, 40, 0, time.UTC)), "20:17:40Z"},
		{"NullOffsetDateTime", NullOffsetDateTimeFromTime(odt), "1969-07-20T20:17:40Z"},
